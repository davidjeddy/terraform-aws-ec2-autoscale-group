...
> **➡️ https://codeberg.org/DavidJEddy/terraform-aws-ec2-autoscale-group**
>
> Please update your remotes:
> ```bash
> git remote set-url origin https://codeberg.org/DavidJEddy/terraform-aws-ec2-autoscale-group
> ```
